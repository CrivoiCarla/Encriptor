...
int generateRandom(int n, char word[],char*  toFile,char*  toFile2)
{
    int aux=n;
		...
		char* pch;
     		while ( fgets (mystring , 1000000 , pFile) != NULL ) {
       			...
       			{	
         			...
         			generateRandom(n, pch, toFile, toFile2);
         			pch = strtok (NULL, " ");
       			}
     		}
     		fclose (pFile);
